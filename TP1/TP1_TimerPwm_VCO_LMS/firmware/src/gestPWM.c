...
void GPWM_Initialize(S_pwmSettings *pData)
{
    ...
    pData->AngleSetting = 0;    // Réglage d'angle initialisé à 0
...
void GPWM_ExecPWM(S_pwmSettings *pData)
{
    ...
    PulseWidthOC3 = pData->absAngle * (PWM_OC3_MAX - PWM_OC3_MIN); // Étape 1 : Échelle sur la plage (2999 - 749)
    PulseWidthOC3 = PulseWidthOC3 / PWM_OC3_DIV;            // Étape 2 : Divise par 180 pour normaliser
    PulseWidthOC3 = PulseWidthOC3 + PWM_OC3_MIN;           // Étape 3 : Ajoute l'offset minimal (749)
