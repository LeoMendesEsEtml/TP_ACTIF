 ...
 */
bool Pec12IsPlus(void) { return (Pec12.Inc); } // Retourne l'état du flag Inc
 ...
 */
bool Pec12IsMinus(void) { return (Pec12.Dec); } // Retourne l'état du flag Dec
 ...
 */
bool Pec12IsOK(void) { return (Pec12.OK); } // Retourne l'état du flag OK
 ...
 */
bool Pec12IsESC(void) { return (Pec12.ESC); } // Retourne l'état du flag ESC
 ...
 */
bool Pec12NoActivity(void) { return (Pec12.NoActivity); } // Retourne l'état du flag NoActivity

/**
 * @brief Vérifie si l'événement OK est actif sur le bouton S9.
 * @return true si l'événement OK est actif, false sinon.
 */
bool S9IsOK(void) { return (S9.OK); } // Retourne l'état du flag OK pour S9

/**
 * @brief Vérifie si l'événement ESC est actif sur le bouton S9.
 * @return true si l'événement ESC est actif, false sinon.
 */
bool S9IsESC(void) { return (S9.ESC); } // Retourne l'état du flag ESC pour S9

/**
 * @brief Annule les flags d'incrément et de décrément du codeur PEC12 (les remet à zéro).
 */
void Pec12ClearPlus(void) { Pec12.Inc = 0; Pec12.Dec = 0; } // Réinitialise Inc et Dec

/**
 * @brief Annule les flags de décrément et d'incrément du codeur PEC12 (les remet à zéro).
 */
void Pec12ClearMinus(void) { Pec12.Dec = 0; Pec12.Inc = 0; } // Réinitialise Dec et Inc

/**
 * @brief Annule le flag OK du codeur PEC12.
 */
void Pec12ClearOK(void) { Pec12.OK = 0; } // Réinitialise OK

/**
 * @brief Annule le flag ESC du codeur PEC12.
 */
void Pec12ClearESC(void) { Pec12.ESC = 0; } // Réinitialise ESC

/**
 * @brief Réinitialise l'état d'activité et la durée d'inactivité du codeur PEC12.
 */
void Pec12ClearInactivity(void) { Pec12.NoActivity = 0; Pec12.InactivityDuration = 0; } // Réinitialise NoActivity et InactivityDuration

/**
 * @brief Annule le flag OK du bouton S9.
 */
void S9ClearOK(void) { S9.OK = 0; } // Réinitialise OK pour S9

/**
 * @brief Annule le flag ESC du bouton S9.
 */
void S9ClearESC(void) { S9.ESC = 0; } // Réinitialise ESC pour S9
