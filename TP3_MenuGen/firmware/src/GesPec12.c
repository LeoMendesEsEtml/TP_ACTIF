...
void ScanBtn(bool ValA, bool ValB, bool ValPB, bool ValS9) {
    ...
    // Détection du flanc descendant sur B pour déterminer la rotation
    if (DebounceIsReleased(&DescrB)) {
        DebounceClearReleased(&DescrB);
        Pec12.InactivityDuration = 0;  // Réinitialisation de l'inactivité
        ...
        // Remettre à zéro si pas de rotation détectée
        Pec12.Inc = 0;
        Pec12.Dec = 0;
    }
    ...
    // Gestion du bouton S9 (Sauvegarde) ? Appuyé = 1, Relâché = 0
